...
echo "🍎 Configuration ATK AI pour macOS"
echo "================================="
...
mkdir -p atkai_back/public
mkdir -p atkai_back/src/app
mkdir -p atkai/src/app
mkdir -p database
mkdir -p docker/php
...
echo "Votre environnement ATK AI est prêt sur macOS."
